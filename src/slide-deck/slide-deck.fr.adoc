...
ne pas trop dépendre de nos outils et petit bonus,
...
[slide=todo-schema]
schéma ères du web (SPA era, client side routing)
...
[slide=todo-schema]
schéma ères du web (storage)

[slide=todo-schema]
schéma ères du web (workers)
