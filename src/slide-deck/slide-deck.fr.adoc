...
"Moi je maintiens un cluster de blockchain-kubernetes-serverless en prod alors ton truc de script là, ça m'a pas l'air si compliqué que ça."
...
OK, bonne remarque.
...
besoins
: bacon + lodash => new
: modules avec interface et isolation
: réutilisabilité
: on veut pas tout jeter pour tout réécrire
: introduire des nouvelles technos feature après feature
...
// on a essayé plusieurs librairies pour écrire des Web Components

//* LitElement
//* https://github.com/hybridsjs/hybrids

[slide=todo-screenshot, data-viewport=1]
DÉMO: storybook driven development
