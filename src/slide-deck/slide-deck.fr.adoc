...
...
OK, alors on utilise tous pleins d'outils qui nous apportent des solutions...

== C'était quoi  le *problème* ?

[.time]#00:06:30#
...mais c'était quoi le problème à la base ?
Sur cette partie, j'ai essayé de lister des problèmes auquels j'ai fait face dans mes différentes expériences de développement sur des web apps.
