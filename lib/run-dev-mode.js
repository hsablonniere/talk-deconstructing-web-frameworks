...
takeScreenshot('http://localhost:8080/index.fr.html', path.resolve(__dirname, '../src/img/poster_4-3.jpg'), {
  width: 1920,
  height: 1440,
}, true);

takeScreenshot('http://localhost:8080/index.fr.html', path.resolve(__dirname, '../src/img/poster_16-9.jpg'), {
  width: 1920,
  height: 1080,
}, true);
